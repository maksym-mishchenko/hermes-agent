...
exec bwrap \
  ...
  --setenv CURL_CA_BUNDLE /work/certs/trust.pem \
  --setenv SSL_CERT_FILE /work/certs/trust.pem \
  --setenv GIT_SSL_CAINFO /work/certs/trust.pem \
  --setenv NODE_EXTRA_CA_CERTS /work/certs/trust.pem \
